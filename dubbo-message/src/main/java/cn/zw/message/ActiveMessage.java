 ...
 * @description active消息的实现
 * @auther 'Amos'
 * @created 2016/9/8  18:20
 */
public class ActiveMessage implements MessageAble {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(
                ...
                ActiveMQConnection.DEFAULT_PASSWORD, "tcp://server1:61616");
        try { // 构造从工厂得到连接对象
